...
export const OCCUPANCY_DIVISIONS: OccupancyDivision[] = [
  ...
  { code: 'M-1', name: 'Túnel', group: 'M', description: 'Túneis', 
    systemTypeRules: [{ systemType: 3 }] },
  { code: 'M-2', name: 'Líquidos/gases combustíveis', group: 'M', description: 'Líquidos e gases combustíveis e inflamáveis', 
    systemTypeRules: [{ systemType: 4 }] },
  ...
  { code: 'M-5', name: 'Silos', group: 'M', description: 'Silos e armazéns', 
    systemTypeRules: [{ systemType: 3 }] },
  { code: 'M-6', name: 'Restrição de mobilidade', group: 'M', description: 'Locais com restrição de movimentação', 
    systemTypeRules: [{ systemType: 2 }] },
  { code: 'M-7', name: 'Edificações especiais', group: 'M', description: 'Torres, plataformas, dutos', 
    systemTypeRules: [{ systemType: 3 }] },
